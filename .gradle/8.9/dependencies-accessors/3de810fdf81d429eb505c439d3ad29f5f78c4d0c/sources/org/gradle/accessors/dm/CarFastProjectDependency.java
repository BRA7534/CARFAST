...
@NonNullApi
public class CarFastProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CarFastProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
